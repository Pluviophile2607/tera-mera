          ...
          <div className="space-y-12">
            ...
            <div className="space-y-8">
              <div className="bg-white border-[3px] border-black p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 transition-transform">
                ...
                <p className="text-xl font-black">hello@teramera.local</p>
              </div>
              <div className="bg-white border-[3px] border-black p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 transition-transform">
                <span className="text-xs font-black uppercase text-secondary-dim tracking-widest mb-2 block">PARTNERSHIPS</span>
                <p className="text-xl font-black">hubs@zedfoundation.org</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    className="w-full p-5 border-[3px] border-black bg-white focus:outline-none focus:bg-primary-container font-bold text-lg"
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    className="w-full p-5 border-[3px] border-black bg-white focus:outline-none focus:bg-secondary-container font-bold text-lg"
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <textarea 
                    ...
                    className="w-full p-5 border-[3px] border-black bg-white focus:outline-none focus:bg-tertiary-container font-bold text-lg"
                  ></textarea>
                </div>
                <button 
                  type="submit"
                  className="w-full py-6 bg-primary-custom text-on-primary text-xl font-black uppercase border-[3px] border-black shadow-[8px_8px_0px_0px_#000] hover:-translate-y-1 hover:shadow-[12px_12px_0px_0px_#000] active:translate-y-0 active:shadow-none transition-all flex items-center justify-center gap-4"
                >
                  SEND MESSAGE
